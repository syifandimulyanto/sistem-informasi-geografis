<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <form id="form_input" action="<?php echo backend_url('position/save') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating">
                                ...
                                <select name="parent_id" class="selectpicker" data-style="select-with-transition" title="Choose parent">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('.datatables').DataTable( {
                        ajax: backend_url+'position/get_data'
                    });
    ...
    function append_parent(value, label)
    {
        $('select[name=parent_id]').append('<option value="'+value+'">'+label+'</option>');
        $('.selectpicker').selectpicker('refresh');
    }
    ...
    {
        $.ajax({
            url         : backend_url+'position/detail',
            type        : 'POST',
            data        : 'id='+id,
            dataType    : 'JSON',
            beforeSend  : function()
            ...
            success: function(data)
            {
                ...
                $('#form_input').find('select[name=parent_id]').val(data.parent_id);
                $('.selectpicker').selectpicker('refresh')
            },
        ...
        $.ajax({
            ...
            success: function(data)
            {
                if(data.status)
                {
                    ...
                    if(data.type == 'save')
                    {
                        append_parent(data.id, data.name);
                    }
