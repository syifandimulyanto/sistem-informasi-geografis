<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <form id="form_input" action="<?php echo backend_url('facilities/save') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating">
                                ...
                                <input type="text" class="form-control" name="icon" required="true">
                            </div>
                            <div class="form-group label-floating">
                                <label class="control-label">
                                    Description
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('.datatables').DataTable( {
                        ajax: backend_url+'facilities/get_data'
                    });
    ...
    {
        $.ajax({
            url         : backend_url+'facilities/detail',
            type        : 'POST',
            data        : 'id='+id,
            dataType    : 'JSON',
            beforeSend  : function()
            ...
            success: function(data)
            {
                ...
                $('#form_input').find('input[name=icon]').val(data.icon);
