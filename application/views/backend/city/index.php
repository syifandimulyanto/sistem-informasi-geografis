<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <form id="form_input" action="<?php echo backend_url('city/save') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating">
                                ...
                                <select name="province_id" class="selectpicker" data-style="select-with-transition" title="Choose parent">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('.datatables').DataTable( {
                        ajax: backend_url+'city/get_data'
                    });
    ...
    function editData(id)
    {
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('#form_input').find('select[name=province_id]').val(data.province_id);
                $('.selectpicker').selectpicker('refresh')
            },
