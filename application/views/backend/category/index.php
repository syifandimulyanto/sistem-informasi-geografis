<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <form id="form_input" action="<?php echo backend_url('category/save') ?>" method="POST" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('.datatables').DataTable( {
                        ajax: backend_url+'category/get_data'
                    });
    ...
    {
        $.ajax({
            url         : backend_url+'category/detail',
            type        : 'POST',
            data        : 'id='+id,
            dataType    : 'JSON',
            beforeSend  : function()
