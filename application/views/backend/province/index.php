<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <form id="form_input" action="<?php echo backend_url('province/save') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating">
                                ...
                                <select name="country_id" class="selectpicker" data-style="select-with-transition" title="Choose parent">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('.datatables').DataTable( {
                        ajax: backend_url+'province/get_data'
                    });
    ...
    {
        $.ajax({
            url         : backend_url+'province/detail',
            type        : 'POST',
            data        : 'id='+id,
            dataType    : 'JSON',
            beforeSend  : function()
            ...
            success: function(data)
            {
                ...
                $('#form_input').find('select[name=country_id]').val(data.country_id);
                $('.selectpicker').selectpicker('refresh')
            },
